...
@SearchIndexable
public class AboutDeviceMoreFragment extends DashboardFragment
        implements DeviceNamePreferenceController.DeviceNamePreferenceHost {

    private static final String LOG_TAG = "AboutDeviceMoreFragment";
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.about_device_more;
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
            Context context, AboutDeviceMoreFragment fragment, Lifecycle lifecycle) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.about_device_more) {
